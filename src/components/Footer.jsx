...
export function Footer() {
  return (
    <footer className="glass-panel border-x-0 border-b-0 border-t border-white/10 pt-16 pb-24 md:pb-12 mt-12 w-full shadow-[0_-10px_30px_rgba(0,0,0,0.3)]">
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 md:gap-12">
          ...
          <div className="flex flex-col gap-5">
            ...
            <p className="text-[14px] text-brand-text-muted leading-relaxed pr-4">
            ...
            <div className="flex items-center gap-3 mt-2">
              <a href="#" className="w-9 h-9 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-white hover:bg-brand-orange hover:border-brand-orange hover:text-white transition-all hover:-translate-y-1 shadow-sm hover:shadow-[0_0_15px_rgba(255,123,0,0.5)]">
          ...
          <div className="flex flex-col gap-4">
            <h3 className="text-lg font-bold text-white mb-2 relative inline-block">
              Quick Links
              <span className="absolute -bottom-1 left-0 w-8 h-1 bg-brand-orange rounded-full shadow-[0_0_10px_rgba(255,123,0,0.8)]"></span>
            </h3>
            {[
              { name: 'Home', path: '/' },
              ...
              <Link key={link.name} to={link.path} className="group flex items-center text-[14px] text-brand-text-muted hover:text-brand-orange transition-colors w-fit">
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="flex items-start gap-3 text-[14px] text-brand-text-muted group cursor-default">
              <div className="w-8 h-8 rounded-full bg-white/5 border border-white/10 flex items-center justify-center shrink-0 group-hover:bg-brand-orange group-hover:border-brand-orange group-hover:shadow-[0_0_15px_rgba(255,123,0,0.5)] transition-all text-white">
                <MapPin className="w-4 h-4" />
              </div>
              <span className="leading-relaxed mt-1 group-hover:text-white transition-colors">1-1-738, Vinayaka temple road,<br/>Koratla, Telangana, India<br/><span className="text-[11px] opacity-70 font-medium">GSTIN: 36BANPK1643M1ZC</span></span>
            </div>
            <div className="flex items-center gap-3 text-[14px] text-brand-text-muted group cursor-default">
              <div className="w-8 h-8 rounded-full bg-white/5 border border-white/10 flex items-center justify-center shrink-0 group-hover:bg-brand-orange group-hover:border-brand-orange group-hover:shadow-[0_0_15px_rgba(255,123,0,0.5)] transition-all text-white">
            ...
            <div className="flex items-center gap-3 text-[14px] text-brand-text-muted group cursor-default">
              ...
              <span className="font-medium group-hover:text-white transition-colors">zesto@gmail.com</span>
            </div>
          </div>
        ...
        <div className="mt-16 pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-[13px] text-brand-text-muted font-medium">
            © {new Date().getFullYear()} Zesto. All rights reserved.
          </p>
          <div className="flex items-center gap-6 text-[13px] text-brand-text-muted font-medium">
