        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-8 bg-[#033429] p-8 md:p-10 rounded-3xl border border-[#065A46] shadow-xl">
          ...
          <div className="w-full md:w-auto flex-1 max-w-md flex items-center gap-2 relative">
            <input 
              ...
              className="w-full bg-[#012980] border border-[#065A46] rounded-full py-3.5 pl-6 pr-32 text-sm text-white placeholder-gray-400 focus:outline-none focus:ring-1 focus:ring-brand-navy transition-all"
            />
            <button className="absolute right-1.5 top-1.5 bottom-1.5 bg-gradient-to-r from-brand-navy to-blue-500 hover:from-brand-navy/90 hover:to-yellow-500/90 text-white font-bold px-6 rounded-full text-sm transition-all shadow-lg hover:shadow-brand-navy/30">
              Subscribe
            </button>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 md:gap-12">
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="flex items-center gap-3 mt-2">
              <a href="#" className="w-10 h-10 rounded-full bg-[#001d5a] border border-brand-navy/30 flex items-center justify-center text-brand-navy hover:bg-brand-navy hover:text-white transition-all hover:-translate-y-1 shadow-[0_4px_10px_rgba(255,153,0,0.1)]">
          ...
          <div className="flex flex-col gap-4">
            <h3 className="text-lg font-bold text-white mb-2 relative inline-block">
              Quick Links
              <span className="absolute -bottom-1 left-0 w-8 h-1 bg-brand-navy rounded-full"></span>
            </h3>
            {[
              { name: 'Home', path: '/' },
              ...
              <Link key={link.name} to={link.path} className="group flex items-center text-[14px] text-gray-300 hover:text-brand-navy transition-colors w-fit">
                <ChevronRight className="w-4 h-4 mr-1 opacity-0 -ml-5 group-hover:opacity-100 group-hover:ml-0 transition-all text-brand-navy" />
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="flex items-start gap-3 text-[14px] text-gray-300 group cursor-default">
              <div className="w-9 h-9 rounded-full bg-[#001d5a] border border-brand-navy/20 flex items-center justify-center shrink-0 group-hover:bg-brand-navy group-hover:border-brand-navy transition-all text-brand-navy group-hover:text-white">
                <MapPin className="w-4 h-4" />
              </div>
              <span className="leading-relaxed mt-1 group-hover:text-white transition-colors">1-1-738, Vinayaka temple road,<br/>Koratla, Telangana, India<br/><span className="text-[11px] text-brand-navy/70 font-medium tracking-wider">GSTIN: 36BANPK1643M1ZC</span></span>
            </div>
