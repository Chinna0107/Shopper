  ...
  return (
    <div ref={container} className="py-16 md:py-24 border-t border-gray-100 mt-12 w-full">
      <div className="flex justify-between items-end mb-12 carousel-item px-4 md:px-0">
        ...
        <Link to="/category/all" className="hidden md:block uppercase font-bold tracking-[0.2em] text-xs border-b border-brand-maroon pb-1 hover:text-brand-navy transition-colors">
          View All
        </Link>
      </div>
