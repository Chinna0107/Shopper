    ...
    <div className="bg-[#f9f9f9] min-h-screen pb-20 md:pb-0 font-sans">
      ...
      <div className="bg-[#012980] pt-12 pb-24 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10 text-center">
          <motion.div initial={{ scale: 0 }} animate={{ scale: 1 }} className="w-16 h-16 rounded-full bg-brand-navy/20 flex items-center justify-center mx-auto mb-6 border border-brand-navy/30">
            <Scale className="w-8 h-8 text-brand-navy" />
          </motion.div>
      ...
      <div className="max-w-4xl mx-auto px-4 md:px-8 -mt-12 relative z-20 pb-24">
        <div className="bg-white rounded-3xl shadow-xl border border-gray-100 p-8 md:p-12 text-gray-700 leading-relaxed space-y-8">
          ...
          <section>
            <h2 className="text-2xl font-bold text-[#012980] mb-4 font-serif">1. Acceptance of Terms</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-[#012980] mb-4 font-serif">2. Provision of Services</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-[#012980] mb-4 font-serif">3. Use of the Services</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-[#012980] mb-4 font-serif">4. Limitation of Liability</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-[#012980] mb-4 font-serif">5. Changes to the Terms</h2>
